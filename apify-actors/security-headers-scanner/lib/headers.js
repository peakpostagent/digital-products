...
// CommonJS export for Node — added when porting from Chrome extension to Apify Actor.
// The browser version doesn't need this (functions are file-level globals loaded via
// <script> tag). Node needs explicit exports.
