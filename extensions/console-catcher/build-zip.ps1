# Regenerate console-catcher.zip from src/.
# Mirrors the pattern in extensions/meeting-cost-calculator/build-zip.ps1.
#
# Usage:
#   powershell -ExecutionPolicy Bypass -File build-zip.ps1
#   powershell -ExecutionPolicy Bypass -File build-zip.ps1 -Version 1.0.3
...
$outZip = Join-Path $PSScriptRoot "console-catcher$suffix.zip"
